...
@Component({
    selector: 'app-electricity-spss',
    templateUrl: './electricity-spss.component.html',
    styleUrls: ['./electricity-spss.component.less'],
})
export class ElectricitySpssComponent implements OnInit {
    searchData = {
        dateType: 'day',
        deviceCategoryId: '1',
        deviceNo: null,
    ...
    loadDevices() {
        this.deviceService.list({ deviceCategoryId: '1' }).subscribe((res) => {
            this.deviceList = res;
        });
    }
