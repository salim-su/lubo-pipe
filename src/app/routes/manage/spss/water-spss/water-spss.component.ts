...
@Component({
    selector: 'app-water-spss',
    templateUrl: './water-spss.component.html',
    styleUrls: ['./water-spss.component.less'],
})
export class WaterSpssComponent implements OnInit {
    searchData = {
        dateType: 'month',
        deviceCategoryId: '3',
        deviceNo: null,
            ...
            tooltip: {
                ...
                formatter: (params, ticket, callback) => {
                    ...
                    for (let i = 0; i < params.length; i++) {
                        ...
                        showHtm += params[i].marker + name + ':' + value / 100 + 'm³' + '<br>';
                    }
                    return showHtm;
                },
            },
            ...
            series: [
                {
                    ...
                    color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
                        { offset: 0, color: '#4CD8E5' },
                        { offset: 1, color: '#2C90C3' },
                    ]),
                },
            ],
        });
    ...
    chartsAlarmSpss(searchData) {
        this.spssService.loadYongShuiLiang(searchData).subscribe((res) => {
    ...
    loadDevices() {
        this.deviceService.list({ deviceCategoryId: '3' }).subscribe((res) => {
            this.deviceList = res;
        });
    }
